...
public class gato {
    ...
    public gato(String jugador1Id, String jugador1Nombre, String jugador2Id, String jugador2Nombre, unCliente cliente1, unCliente cliente2){
    ...
    public String procesarMovimiento(String clienteId, int fila, int columna) throws IOException {
        ...
        if(verificarGanador(simbolo)){
            ...
            String nombreGanadorReal = SisAutenticacion.getNombreUsuarioReal(ganadorClienteId);
            String nombrePerdedorReal = SisAutenticacion.getNombreUsuarioReal(perdedorClienteId);
            if(nombreGanadorReal != null && nombrePerdedorReal != null){
                ...
                bdd.rVic(nombreGanadorReal, nombrePerdedorReal);
            } else {
        ...
        if(verificarEmpate()){
            ...
            String nombreJ1Real = SisAutenticacion.getNombreUsuarioReal(jugador1Id);
            String nombreJ2Real = SisAutenticacion.getNombreUsuarioReal(jugador2Id);
            if(nombreJ1Real != null && nombreJ2Real != null){
                System.out.println("Registrando empate entre: " + nombreJ1Real + " y " + nombreJ2Real);
                bdd.rEmp(nombreJ1Real, nombreJ2Real);
            } else {
                System.out.println("No se registraron estadisticas (uno o ambos jugadores son invitados)");
            }
